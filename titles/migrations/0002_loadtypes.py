...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "add initial data to populate basic types such as ConductorType, ScoreType, OrchestraType"
        # Note: Remember to use orm['appname.ModelName'] rather than "from appname.models..."
        orm.ConcertType.objects.create(name='Pops')
        orm.OrchestraType.objects.create(name='Full')
        orm.OrchestraType.objects.create(name='Chamber')
        orm.OrchestraType.objects.create(name='String')
        orm.ScoreType.objects.create(name='Full Score')
        orm.ScoreType.objects.create(name='Piano Conductor')
